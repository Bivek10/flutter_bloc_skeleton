...
mixin _$ChatMessageModel {
 ...
 String get id; String get senderId; String get text; int get timestamp; String get roomId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,senderId,text,timestamp,roomId);

@override
String toString() {
  return 'ChatMessageModel(id: $id, senderId: $senderId, text: $text, timestamp: $timestamp, roomId: $roomId)';
}
...
@useResult
$Res call({
 String id, String senderId, String text, int timestamp, String roomId
});
...
/// Create a copy of ChatMessageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? senderId = null,Object? text = null,Object? timestamp = null,Object? roomId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String senderId,  String text,  int timestamp,  String roomId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatMessageModel() when $default != null:
return $default(_that.id,_that.senderId,_that.text,_that.timestamp,_that.roomId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String senderId,  String text,  int timestamp,  String roomId)  $default,) {final _that = this;
switch (_that) {
case _ChatMessageModel():
return $default(_that.id,_that.senderId,_that.text,_that.timestamp,_that.roomId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String senderId,  String text,  int timestamp,  String roomId)?  $default,) {final _that = this;
switch (_that) {
case _ChatMessageModel() when $default != null:
return $default(_that.id,_that.senderId,_that.text,_that.timestamp,_that.roomId);case _:
  return null;
...
class _ChatMessageModel extends ChatMessageModel {
  const _ChatMessageModel({required this.id, required this.senderId, required this.text, required this.timestamp, required this.roomId}): super._();
...
/// Create a copy of ChatMessageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? senderId = null,Object? text = null,Object? timestamp = null,Object? roomId = null,}) {
